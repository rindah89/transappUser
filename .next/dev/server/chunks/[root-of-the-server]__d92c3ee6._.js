...
"[project]/src/app/api/v1/bookings/cancel/[bookingId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    try {
        ...
        const { data: booking, error: bookingError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('bookings').select('*').eq('id', bookingId).eq('booker_id', user.id).single();
        if (bookingError) {
            if (bookingError.code === 'PGRST116') throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](404, 'Booking not found');
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, bookingError.message);
        }
        if (!booking) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](404, 'Booking not found');
        ...
        if (rpcError) {
            ...
            const { data: trip } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('trips').select('reserved').eq('id', booking.trip_id).single();
        ...
        const { data: updated, error: updatedError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('bookings').select('*').eq('id', bookingId).single();
        if (updatedError) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, updatedError.message);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: false,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: true,
            message: httpError.message || 'Failed to cancel booking'
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d92c3ee6._.js.map