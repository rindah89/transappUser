...
"[project]/src/app/api/v1/bookings/booking/[bookingId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const { data: booking, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('bookings').select('*').eq('id', bookingId).eq('booker_id', user.id).single();
        if (error) {
            if (error.code === 'PGRST116') throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](404, 'Booking not found');
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, error.message);
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: true,
            message: httpError.message || 'Failed to retrieve booking'
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8d86240._.js.map