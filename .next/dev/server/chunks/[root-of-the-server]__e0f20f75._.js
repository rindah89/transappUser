...
"[project]/src/app/api/v1/bookings/create-booking/[tripId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    try {
        ...
        const { data: trip, error: tripError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('trips').select('*').eq('id', tripId).single();
        if (tripError) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, tripError.message);
        if (!trip) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](404, 'Trip not found');
        if (trip.reserved >= trip.seats) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](409, 'No seats available for this trip');
        const journeyDate = body.journey_date || trip.journey_date;
        const year = body.year || trip.year || new Date(journeyDate).getFullYear().toString();
        const month = body.month || trip.month || monthShort(journeyDate);
        const insertPayload = {
            trip_id: tripId,
            booker_id: user.id,
            name: body.name ?? user.name ?? '',
            phone_number: typeof body.phone_number === 'number' ? body.phone_number : user.phone_number ? Number(user.phone_number) : null,
            ...
            seat: body.seat ?? null,
            status: body.status ?? '',
            booking_fee: body.booking_fee ?? null,
            payer_name: body.payer_name ?? null,
            payer_phone: body.payer_phone ?? null
        };
        if (!insertPayload.seat) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](400, 'Seat is required');
        }
        // Best-effort: prevent duplicate seat selection (non-atomic)
        const { data: seatRow, error: seatError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('bookings').select('id').eq('trip_id', tripId).eq('seat', insertPayload.seat).limit(1);
        if (seatError) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, seatError.message);
        if ((seatRow || []).length > 0) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](409, 'Seat already taken');
        const { data: booking, error: bookingError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('bookings').insert(insertPayload).select('*').single();
        if (bookingError) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, bookingError.message);
        if (!booking) throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$exceptions$2f$HttpException$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpException"](500, 'Failed to create booking');
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: true,
            message: httpError.message || 'Failed to create booking'
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e0f20f75._.js.map